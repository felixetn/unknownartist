...
#define configCLKP1_CLOCK_HZ		( ( unsigned long ) 16000000 )	/* Clock setup from start.asm in the demo application. */
...
extern unsigned long runTimerValue;
#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS() vConfigureTimerForRunTimeStats()
#define portGET_RUN_TIME_COUNTER_VALUE() runTimerValue
#endif
