...
/*****************************************************************************/
static int8_t steeringOffset = 0;
...
void Drive_SetServo(int16_t percent) {
	...
	switch(carid){
		case 1:
			steeringOffset = 18; // 17,77
			break;
		case 2:
			steeringOffset = 25; // NEW
			break;
		case 3:
			steeringOffset = 6; //-6,08
			break;
		case 4:
			steeringOffset = 17; //NEW
			break;
		case 5:
			steeringOffset = 3; //NEW
			break;
		case 6:
			steeringOffset = 7; //NEW
			break;
		case 7:
			steeringOffset = 8; //NEW
			break;
		default:
			steeringOffset = 0;
			break;
	...
	//Sollte man vielleicht auf -75 , 75 stellen ?
